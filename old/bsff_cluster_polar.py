#guess ill have to add this manually for every lig for now
...
'''
time python ~/BSFF/rcp/rcpa8slib.py a8s includebb Fragment_X Fragment_X_fuzzball_path params_path
time python ~/BSFF/rcp/rcpa8slib.py a8s yes Fragment_2 /wynton/home/kortemme/cgalvin/round6/a8s/a8s_polar_contact_fuzzball.pdb /wynton/home/kortemme/cgalvin/round6/a8s/Inputs/Rosetta_Inputs/a8s.params
'''
#
parent_directory=sys.argv[1]
includebb=sys.argv[2]
f1=sys.argv[3]
fbpath=sys.argv[4]
paramspath=sys.argv[5]
'''
parent_directory='a8s'
includebb='yes'
f1='Fragment_2'
fbpath='/wynton/home/kortemme/cgalvin/round6/a8s/a8s_polar_contact_fuzzball.pdb'
...
fragdata[f1]=[fbpath]
fraglist=[f1]
# pdfname=str(parent_directory)+'_'+str(f1)+'_polar_clusters_plots_liberal.pdf'
...
#
if includebb=='no':
    polar_residues=['LYS','ARG','ASP','GLU','SER','THR','GLN','ASN','HIS','TYR','TRP'] #ONLY TRUE POLAR AND GLY
else:
    polar_residues=['LYS','ARG','ASP','GLU','SER','THR','GLN','ASN','HIS','TYR','TRP','GLY'] #ALL EXCEPT PRO,CYS,MET
...
out_filejson2 = open(parent_directory+'_'+str(f1)+'_polar_contacts_clustered_liberal.json','w')
