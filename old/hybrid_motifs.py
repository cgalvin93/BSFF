#time python enumerate_hybrid_motifs.py clusterresults.json n_clust_each_frag lig_resname nmotifres ligparams
...
nps=sorted(npclusts, key=lambda x: x[1],reverse=True)
'''
...
'''
np_cst_blocks=[]
for clust,freq in nps[:20]: #####can change this from 20 to anything
    p = Pose()
